...
- Donnees d'essai E2E NETTOYEES le 2026-07-19 (base propre : zero vente web). EN ATTENTE : MERGE `--no-ff` vers main + go-live = Vague 3, feu vert explicite. Env a poser dans Vercel projet site au merge : `SUPABASE_SITE_ECRIVAIN_JWT`, `RESEND_API_KEY`, `RESEND_DEST_TEST`.
