...
- 0019 `site_lecteur` APPLIQUEE le 2026-07-18, bascule du site TERMINEE le meme jour (JWT en service, echeance 2036-07-18 ; service_role sortie de `site/.env.local` ; preuve zero fuite + E2E verts). Migrations referentielles : 0019, 0020, 0022 et 0021 APPLIQUEES le 2026-07-18. Prochaine etape : 0023 (`horaire_boutique`, creation de table + SEED des horaires reels dans la meme migration) selon la meme procedure (dry-run puis feu vert). Ensuite : UI Atelier (Catalogue + Reglages) et consommation cote site. Avant deploiement : favicon a choisir.
