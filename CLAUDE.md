...
- 0019 `site_lecteur` APPLIQUEE le 2026-07-18, bascule du site TERMINEE le meme jour (JWT en service, echeance 2036-07-18 ; service_role sortie de `site/.env.local` ; preuve zero fuite + E2E verts). Prochaine etape : migration 0020 (`produit.description` + `visible_site`) apres feu vert. Avant deploiement : favicon a choisir.
