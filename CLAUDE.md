...
- 0019 `site_lecteur` APPLIQUEE le 2026-07-18, bascule du site TERMINEE le meme jour (JWT en service, echeance 2036-07-18 ; service_role sortie de `site/.env.local` ; preuve zero fuite + E2E verts). Migrations referentielles : 0019 et 0020 APPLIQUEES le 2026-07-18. Prochaine etape : 0022 (`emplacement` : ville, lieu, horaire_service) selon la meme procedure (dry-run puis feu vert), puis 0021 et 0023. Avant deploiement : favicon a choisir.
