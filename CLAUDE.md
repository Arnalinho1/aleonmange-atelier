...
- 0019 `site_lecteur` APPLIQUEE le 2026-07-18, bascule du site TERMINEE le meme jour (JWT en service, echeance 2036-07-18 ; service_role sortie de `site/.env.local` ; preuve zero fuite + E2E verts). Migrations referentielles : 0019, 0020 et 0022 APPLIQUEES le 2026-07-18. Prochaine etape : 0021 (`famille_carte`, premiere CREATION de table : RLS + policies equipe + grant/policy site_lecteur dans la MEME migration) selon la meme procedure (dry-run puis feu vert), puis 0023. Avant deploiement : favicon a choisir.
