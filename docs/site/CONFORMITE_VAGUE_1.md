...
Nettoyage : samedi remis a 14h00 et Tzatziki reactive + revisible (verifie a l'ecran) ; conserves comme contenu reel : description Croque-monsieur, emplacement enrichi, et la famille « Paniers Frais » (VOLONTAIREMENT en attente : future categorie boutique que les chefs rempliront). Saisie non declaree decouverte pendant la verification (« La Salade d'Arnaud », truck) : traitee par Arnaud en cloture de session (desactivee / masquee du site).
